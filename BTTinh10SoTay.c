...
int main(){
    int S,N; // Khai báo biến S, N.
    S = (500 * 10); // Tính tổng 10 cuốn sổ tay giá gốc.
    N = S - (S * 20 / 100); // Tính tổng 10 cuốn sổ tay sau khi giảm giá 20%.
    printf("Tong tien 10 cuon so tay gia goc la: %d", S); // In ra tổng giá tiền 10 cuốn sổ tay giá gốc.
    printf("\nTong tien 10 cuon so tay sau khi giam 20%% la: %d", N); // In ra tổng giá tiền sau khi giảm 20%.
}
