...
int main(){
    ...
    switch(kytu){
        case '+':
            printf("Tong hai so a va b la : a + b = %.2f",a + b); // In ra tổng hai số a và b nếu là ký tự '+'.
            break;
        
        case '-':
            printf("Hieu hai so a va b la : a - b = %.2f",a - b); // In ra tổng hai số a và b nếu là ký tự '-'.
            break;
        
        default :
            printf("Vui long nhap lai"); // Yêu cầu người dùng nhập lại.
            break;
    }
}
